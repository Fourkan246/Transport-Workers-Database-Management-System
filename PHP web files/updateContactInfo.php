...
<form action="" method="post" >
              ...
              <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                      <label for="InputEducationalQualification">Phone Number 1</label>
                      <br><input class="form-control" type="number" name="phone_number" </br>
                  </div>
                  <div class="form-group">
                      <label for="InputYearsOfExperience">Phone Number 2</label>
                      <br><input class="form-control" type="number" name="phone_number2" </br>
                  </div>

                  <div class="form-group">
                      <label for="InputPreviousOrganization">Email Address 1</label>
                      <br><input class="form-control" type="text" name="email" </br>
                  </div>
                  <div class="form-group">
                      <label for="InputEducationalQualification">Email Address 2</label>
                      <br><input class="form-control" type="text" name="email2" </br>
                  </div>
        ...
        $insertq = oci_parse($db, "Insert into phone_no(emp_id,Phone_num)
        values ('$nid','$Phone_number')");
        oci_execute($insertq);

        oci_free_statement($insertq);


        $insertq2 = oci_parse($db, "Insert into phone_no(emp_id,Phone_num)
        values ('$nid','$Phone_number2')");
        oci_execute($insertq2);

        oci_free_statement($insertq2);

        $insertq3 = oci_parse($db, "Insert into email(emp_id,email_id)
        values ('$nid','$Email')");
        oci_execute($insertq3);

        oci_free_statement($insertq3);

        $insertq4 = oci_parse($db, "Insert into email(emp_id,email_id)
        values ('$nid','$Email2')");
        oci_execute($insertq4);

        oci_free_statement($insertq4);
