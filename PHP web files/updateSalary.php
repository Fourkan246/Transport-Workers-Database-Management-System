...
<form action="" method="post" >
              ...
              <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                      <label for="InputEducationalQualification">Driver Basic Salary</label>
                      <br><input class="form-control" type="number" name="driver" </br>
                  </div>


                  <div class="form-group">
                      <label for="InputEducationalQualification">Supervisor Basic Salary</label>
                      <br><input class="form-control" type="number" name="supervisor" </br>
                  </div>


                  <div class="form-group">
                      <label for="InputEducationalQualification">Conductor Basic Salary</label>
                      <br><input class="form-control" type="number" name="conductor" </br>
                  </div>


                  <div class="form-group">
                      <label for="InputEducationalQualification">Office Worker Basic Salary</label>
                      <br><input class="form-control" type="number" name="office" </br>
                  </div>
        ...
        $get = oci_parse($con,"select emp_type from employee
        where emp_id='$nid'");
        oci_execute($get);
        ...
        if($driver!=null)
        {
            $get2 = oci_parse($con,"update sal_check set basic='$driver'
   ...
   <div class="alert alert-success alert-dismissible">
     ...
     <strong>Success!</strong> Driver Salary Updated Properly!!!
   </div>
 <?php
        ...
        if($supervisor!=null)
        {
            $get3 = oci_parse($con,"update sal_check set basic='$supervisor'
        where emp_type='Supervisor'");
        oci_execute($get3);
        ?>
        <div class="container">
   ...
   <div class="alert alert-success alert-dismissible">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Success!</strong> Supervisor Salary Updated Properly!!!
   </div>
 <?php
        ...
        if($conductor!=null)
        {
            $get4 = oci_parse($con,"update sal_check set basic='$conductor'
        where emp_type='Conductor'");
        oci_execute($get4);
        ?>
        <div class="container">
   ...
   <div class="alert alert-success alert-dismissible">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Success!</strong> Conductor Salary Updated Properly!!!
   </div>
 <?php
        ...
        if($office!=null)
        {
            $get5 = oci_parse($con,"update sal_check set basic='$office'
        where emp_type='Office'");
        oci_execute($get5);
        ?>
        <div class="container">
   ...
   <div class="alert alert-success alert-dismissible">
     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     <strong>Success!</strong> Office Worker Salary Updated Properly!!!
   </div>
 <?php

        }

        //$get2 = oci_parse($con,"update sal_check set basic='$basic'
        //where emp_type='$type'");
        //oci_execute($get2);
        /*while($row1 = oci_fetch_array($get2))
        {

            $basic=$row1[0];

        }
        $food=ceil(0.15*$basic);
        $residence=ceil(0.30*$basic);
        $transport=ceil(0.20*$basic);


        $trans=oci_parse($con,"select transaction_id,ceil(sysdate-transaction_date) from gets_paid
        where emp_id='$nid'");
        oci_execute($trans);
        while($row = oci_fetch_array($trans))
        {

            $transaction_id=$row[0];
            $transacton_date=$row[1];

        }

      //  echo $transaction_date;

        $p=oci_parse($con,"update salary set basic='$basic',food_allowance='$food',transport_allowance='$transport',
        residence_allowance='$residence'
        where Transaction_Id ='$transaction_id' ");
        oci_execute($p);
        //$var="accounts.php?id=".$nid;
