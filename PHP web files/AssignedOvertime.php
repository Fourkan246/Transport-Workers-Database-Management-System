  ...
  <div class="content-wrapper">
    ...
    <?php
     ...
     @ini_set('display_errors', 0);
              $con = oci_connect('dbProject','dbProject','localhost/XE');
              if(!$con)
              {
                $e = oci_error();
        ...
        <form action="" method="post" >
          <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header">Employee Overtime</div>
              <div class="card-body">
                <form>
          ...
          <?php
            ...
            ?>
                  ...
                  <div class="form-group">
                      <label for="InputFatherName">Overtime Date</label>
                      <br><input class="form-control" type="Date" name="overtime_date" >
                  </div>

                  <div class="form-group">
                      <label for="InputFatherName">Shift</label>
                      <br><select id="lala" name="shift">
        ...
        <?php
          $db = oci_connect('dbProject' ,'dbProject','localhost/XE');
          if(!$db)
          {
            $e = oci_error();
            trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
          ...
          $insertq = oci_parse($db, "Insert into Overtime(
            Emp_id ,
            Shift  ,
            Overtime_date )
