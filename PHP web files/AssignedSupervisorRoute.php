  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        <form action="" method="post" >
          <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header">Assign Supervisor Route</div>
              <div class="card-body">
                <form>
                   ...
                   <div class="form-group">
                      <label for="InputFatherName">Supervisor Employee Id</label>
          ...
          <?php
              ...
              $stid = oci_parse($con, "select emp_id from employee where emp_type= 'Supervisor'");
              oci_execute($stid);
            ...
            ?>
                  ...
                  <div class="form-group">
                        ...
                        <label for="exampleInputFirstName">Assigned Route No</label>
          ...
          <?php
            ...
            ?>
                  ...
                  <div class="form-group">
                      <label for="InputEyesight">Route Name</label>
                      <br><input class="form-control" type="text" name="Route_Name" </br>
                  </div>
        ...
        <?php
          ...
          $insertq = oci_parse($db, "Insert into supervisor(
            Emp_id   ,
            Route_no, sv_route  )
          values ('$emp_id','$route_no','$route_name')");
          oci_execute($insertq);
