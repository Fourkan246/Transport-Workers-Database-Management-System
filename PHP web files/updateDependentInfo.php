              ...
              <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                      <label for="InputEducationalQualification">Dependent's NID number</label>
                      <br><input class="form-control" type="text" name="dep_nid" </br>
                  </div>
                  <div class="form-group">
                      <label for="InputYearsOfExperience">Dependent's Name</label>
                      <br><input class="form-control" type="text" name="dep_name" </br>
                  </div>

                  <div class="form-group">
                      <label for="InputPreviousOrganization">Relation</label>
                      <br><input class="form-control" type="text" name="relation" </br>
                  </div>

                <div class="form-group">
                      <label for="InputPreviousOrganization">Gender</label>
                      <br><input class="form-control" type="text" name="gender" </br>
                  </div>
...
@ini_set('display_errors', 0);
        ...
        $insertq = oci_parse($db, "Insert into dependents(dep_nid,dep_name,relation,gender)
          values ('$Dep_nid','$Dep_name','$Relation','$Gender')");
          oci_execute($insertq);

          oci_free_statement($insertq);

          $insertq2 = oci_parse($db, "Insert into depends_on(emp_id,dep_nid)
          values ('$nid','$Dep_nid')");
