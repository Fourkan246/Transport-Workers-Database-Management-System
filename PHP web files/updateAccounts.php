...
$id1=$_GET['id'];
$con = oci_connect('dbProject2','ronaldomessi10','localhost/XE');
if(!$con)
{
    $e = oci_error();
...
<form action="" method="post" >
          <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header"><Strong>Update Your Salary</Strong></div>
              <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                      <label for="InputEducationalQualification">Basic Salary</label>
                      <br><input class="form-control" type="number" name="basic" </br>
                  </div>
   ...
   <div class="alert alert-success alert-dismissible">
     ...
     <strong>Success!</strong> Accounts Updated Properly!!!
   </div>
 <?php
       }
