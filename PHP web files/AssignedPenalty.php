    ...
    <?php
     ...
     @ini_set('display_errors', 0);
        ...
        <form action="" method="post" >
          ...
          <?php
            ...
            ?>
                  ...
                  <div class="form-group">
                      <label for="InputFatherName">Amount Charged</label>
                      <br><input class="form-control" type="text" name="amount_charged" >
                  </div>

                  <div class="form-group">
                      <label for="InputFatherName">Reason of Penalty</label>
                      <br><input class="form-control" type="text" name="reason_of_penalty" ><br>
                  </div>

                  <div class="form-group">
                      <label for="InputFatherName">Penalty Date</label>
                      <br><input class="form-control" type="Date" name="penalty_date"  >
                    </div>
        ...
        <?php
          ...
          $reason_of_penalt  = @$_POST['reason_of_penalty'];
          $penalty_date      = @$_POST['penalty_date'];


          $penalty_slip_no_seq;

           $seq = oci_parse($db, 'select penalty_slip_no_seq.nextval from dual');
            oci_execute($seq);
            while($row = oci_fetch_array($seq))
             {
              $penalty_slip_no_seq = $row[0];
             }
          ...
          $insertq = oci_parse($db, "Insert into penalty(
            Slip_no  ,
            Amount_charged   ,
            Reason_of_penalty   ,
            Penalty_date  )
          ...
          $insertq = oci_parse($db, "Insert into Penalty_charged(
            Slip_no  ,
            Penalty_date  ,
            Emp_id   )
