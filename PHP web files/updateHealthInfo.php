...
<form action="" method="post" >
          <div class="container">
            <div class="card card-register mx-auto mt-5">
              <div class="card-header"><Strong>Update Your Health Information</Strong></div>
              <div class="card-body">
                <form>
                    ...
                    <div class="form-group">
                      ...
                      <br><input class="form-control" type="text" name="height" </br>
                  </div>
                  <div class="form-group">
                      <label for="InputWeight">Weight</label>
                      <br><input class="form-control" type="text" name="weight" </br>
                  </div>

                  <div class="form-group">
                      <label for="InputEyesight">Eyesight</label>
        ...
        $p=oci_parse($con,"select test_serial,test_date from
        employee join health_condition using(emp_id) join healthinfo using (test_serial,test_date)
        where emp_id='$nid'");
        oci_execute($p);
        $serial=0;
        $date=0;
...
if($Height != null)
{
    ...
    $p1 = oci_parse($con, "Update final.healthinfo set height='$Height'
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <strong>Success!</strong> Height Updated!!!
  </div>
<?php
}
...
if($Weight != null)
{
    $p1 = oci_parse($con, "Update final.healthinfo set weight='$Weight'
    where test_serial='$serial' and test_date='$date'");
	oci_execute($p1);
	?>
	<div class="container">
...
if($Eyesight != null)
{
    $p1 = oci_parse($con, "Update final.healthinfo set eyesight='$Eyesight'
    where test_serial='$serial' and test_date='$date'");
	oci_execute($p1);
	?>
	<div class="container">
  ...
  <div class="alert alert-success alert-dismissible">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success!</strong> Eyesight Updated!!!
  </div>
<?php
}
